...
def build_hand_score_matrix(
    ...
    """Return continuous hand-priority scores plus relation layers."""
    ...
    return score, {
        "identity": ident,
        "symbolic_dependency": sym,
        "composition": comp,
        "shape_compat": sc,
        "middle_bridge": middle,
        "local_window": local,
        "same_operator": sameop,
        "embedding_cos": cos_sim,
    }
